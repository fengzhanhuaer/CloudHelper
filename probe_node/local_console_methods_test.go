...
func TestProbeLocalAPIMethodGuards(t *testing.T) {
	...
	cases := []struct {
		...
		{name: "virtual router buffers should reject PUT", method: http.MethodPut, path: "/local/api/virtual_router/buffers", body: map[string]any{}},
		...
		{name: "virtual router diagnostic should reject PUT", method: http.MethodPut, path: "/local/api/virtual_router/diagnostic", body: map[string]any{}},
		...
		{name: "virtual router path rtt should only allow POST", method: http.MethodGet, path: "/local/api/virtual_router/path_rtt", body: nil},
