...
func (s *aiDebugService) Start() error {
	...
	mux.HandleFunc("/debug/network/udp/associations/manager", s.handleNetworkUDPAssociationsManager)
	mux.HandleFunc("/debug/network/udp/associations/controller", s.handleNetworkUDPAssociationsController)
	mux.HandleFunc("/debug/network/udp/associations/probe", s.handleNetworkUDPAssociationsProbe)
	mux.HandleFunc("/debug/network/tcp/debug/manager", s.handleNetworkTCPDebugManager)
	mux.HandleFunc("/debug/network/tcp/debug/controller", s.handleNetworkTCPDebugController)
	mux.HandleFunc("/debug/network/tcp/debug/probe", s.handleNetworkTCPDebugProbe)
