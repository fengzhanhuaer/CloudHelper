...
const (
	...
	probeRouteCodexCarrierSlotHeader  = "X-Codex-VRouter-Carrier-Slot"
	probeRouteCodexMultiCarrierHeader = "X-Codex-VRouter-Multi-Carrier"
	...
	probeRouteRelayQUICMaxStreamWindow         = 4 * 1024 * 1024
	probeRouteRelayQUICInitialConnectionWindow = 1024 * 1024
