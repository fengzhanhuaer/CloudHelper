...
func NewMux() *http.ServeMux {
	...
	mux.HandleFunc("/mng/api/route/virtual_router/fake_ip/reset", mngAuthRequiredMiddleware(mngLinkVirtualRouterFakeIPResetHandler))
	...
	mux.HandleFunc("/mng/api/link/entry_profiles/upsert", mngAuthRequiredMiddleware(mngLinkEntryProfilesUpsertHandler))
