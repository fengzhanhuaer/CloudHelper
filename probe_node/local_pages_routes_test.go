	...
	cases := []struct {
	...
	}{
		{
			...
			contains: []string{
				...
				"id=\"bufferRows\"",
				"id=\"bufferResetBtn\"",
				"/local/api/virtual_router/buffers",
				"function renderBufferStatus(data)",
				"data-tab=\"dnsRecords\"",
				"id=\"dnsRecordSourceSelect\"",
				"id=\"dnsRecordActionSelect\"",
				"dnsRecordAction === 'all' || String(item.last_action || '') === dnsRecordAction",
				"document.getElementById('dnsRecordActionSelect').addEventListener('change'",
				"id=\"dnsTrackingRows\"",
				"id=\"dnsAllowedRows\"",
				...
				"formatBrowserLocalDateTime(item.last_seen)",
