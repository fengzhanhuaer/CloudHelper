  ...
  return (
    <div className="content-block">
      ...
      <div className="identity-card">
        ...
        <div>私钥状态：{props.privateKeyStatus || "未检查"}</div>
        <div>私钥路径：{props.privateKeyPath || "未设置"}</div>
      </div>
      ...
      <div className="content-actions">
        ...
        <button className="btn" onClick={props.onRefreshPrivateKeyStatus}>刷新私钥状态</button>
      </div>
